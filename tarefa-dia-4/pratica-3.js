...
for (let iten of receita){
    total = total + iten.valor
}
...
for (let iten of receita){
    totalGorgetas = totalGorgetas + iten.gorjeta
}

console.log("Total gorgestas:" ,totalGorgetas)
console.log("Total geral:" ,total + totalGorgetas)


//Problema 3: Quantas vendas foram abaixo de 50 reais?
//COLOQUE SUA SOLUÇÃO AQUI
let vendasAbaixo50 = 0; //contador

for (let iten of receita){
    //Se menor que 50 adciona 1 ao contador
    if (iten.valor <50){
